...
usage() {
  cat <<'EOF'
Usage: run_integration_uart_core_tb.sh [--gui] [--clean]
...
VCD_FILE="${RESULTS_DIR}/integration_uart_core_tb.vcd"
EXE_FILE="${RESULTS_DIR}/integration_uart_core_tb"
...
ghdl -e "${GHDL_OPTS[@]}" -o "${EXE_FILE}" integration_uart_core_tb
